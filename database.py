...
def init_db():
    try:
        ...
        # Insertar items
        # Verificar duplicados en items_data e insertar ítems
        ...
        # Actualizar la columna total en categorias
        cursor.execute('''
            UPDATE categorias
            SET total = (
...
# Llamar a init_db para asegurarse de que la base de datos y los datos de prueba están creados
init_db()
